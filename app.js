...
App({
  ...
  listVesselTurnToPage: function (event) {
    ...
    if (page_form != '') {
      if(router == 'tostoreDetail'){
        this.turnToPage('/orderMeal/pages/toStoreDetail/toStoreDetail?detail=' + data_id);
      }else if(router == 'goodsDetail' && isseckill == 1){
        this.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?detail=' + data_id + '&goodsType=seckill');
      } else if (router == 'goodsDetail') {
        this.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?detail=' + data_id );
      }else{
  ...
  dynamicVesselTurnToPage: function (event) {
    ...
    if (isGroup && isGroup == 1) {
      this.turnToPage('/eCommerce/pages/groupGoodsDetail/groupGoodsDetail?detail=' + data_id);
      return;
    }
  ...
  turnToGoodsDetail: function (event) {
    ...
    if (group && group == 1) {
      this.turnToPage('/eCommerce/pages/groupGoodsDetail/groupGoodsDetail?detail=' + id + '&contact=' + contact);
      return;
    }
    switch (+goodsType) {
      case 0:
      case 1: this.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?detail=' + id +'&contact=' + contact +'&hidestock=' + hidestock +'&isShowVirtualPrice='+ isShowVirtualPrice);
        break;
      case 3: this.turnToPage('/orderMeal/pages/toStoreDetail/toStoreDetail?detail=' + id);
        break;
    }
  },
  ...
  turnToSeckillDetail: function (event) {
    ...
    this.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?detail=' + id +'&goodsType=seckill&contact=' + contact);
  },
  ...
  tapGoodsTradeHandler: function (event) {
    if (event.currentTarget.dataset.eventParams) {
      ...
      if (!!goods_id) {
        goods_type == 3 ? this.turnToPage('/orderMeal/pages/toStoreDetail/toStoreDetail?detail=' + goods_id)
          : this.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?detail=' + goods_id);
      }
    }
  },
  ...
  tapGetCouponHandler: function (event) {
    if (event.currentTarget.dataset.eventParams) {
      ...
      this.turnToPage('/eCommerce/pages/couponDetail/couponDetail?detail=' + coupon_id);
    }
  },
  ...
  tapToSeckillHandler: function (event) {
    if (event.currentTarget.dataset.eventParams) {
      ...
      if (!!seckill_id) {
        this.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?goodsType=seckill&detail=' + seckill_id);
      }
    }
  },
...
    return  s;
  ...
  globalData:{
    appId: 'QKEMkcEpUK',
        tabBarPagePathArr: '["/pages/15Sh88HKUD_page10000/15Sh88HKUD_page10000","/pages/15Sh88HKUD_page10006/15Sh88HKUD_page10006","/pages/15Sh88HKUD_page10003/15Sh88HKUD_page10003"]',
        homepageRouter: '15Sh88HKUD_page10000',
    formData: null,
    userInfo: {},
    systemInfo: null,
    sessionKey: '',
    ...
    siteBaseUrl: 'https://jisuapp.zhichiweiye.com',
    appTitle: '泊职微校园',
    appDescription: '泊职微校园',
