...
Page({
  ...
  turnToDetail: function (e) {
    ...
    switch (+goodsType) {
      case 0:
      case 1: appInstance.turnToPage('/eCommerce/pages/goodsDetail/goodsDetail?detail=' + id);
        break;
      case 3: appInstance.turnToPage('/orderMeal/pages/toStoreDetail/toStoreDetail?detail=' + id);
        break;
    }
  },
