...
Page({
  ...
  onShareAppMessage: function(res){
    ...
    return {
      ...
      path: '/eCommerce/pages/couponDetail/couponDetail?status=receive&detail=' + couponId + '&franchisee=' + franchiseeId,
      success: function(res){
        // console.log('转发成功');
      },
      fail: function(res){
  ...
  turnToCouponGoodsList: function (event) {
    ...
    app.turnToPage('/eCommerce/pages/couponGoodsListPage/couponGoodsListPage?detail='+ couponId);
  }
})
