...
Page({
  ...
  onShareAppMessage: function(){
    ...
    let that = this,
      ...
      path = '/eCommerce/pages/goodsDetail/goodsDetail?detail=' + goodsId + '&contact=' + contact + (franchiseeId ? '&franchisee=' + franchiseeId + '&cart_num=' + cart_num : '') + urlSeckill + urlPromotion;
